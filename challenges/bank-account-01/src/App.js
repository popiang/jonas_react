...
export default function App() {
    const [{balance, loan, isActive}, dispatch] = useReducer(bankReducer, initialState);
    ...
    return (
        <div className="App">
            ...
            <p>
                <button onClick={() => dispatch({type: "requestLoan", payload: 5000})} disabled={!isActive || loan !== 0}>
                    Request a loan of 5000
                </button>
            </p>
            <p>
                <button onClick={() => dispatch({type: "payLoan", payload: 5000})} disabled={!isActive || loan === 0}>
                    Pay loan
                </button>
            </p>
            <p>
